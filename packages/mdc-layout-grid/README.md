...
The Material Design spec recommends 8px/16px/24px/40px as the padding sizes to choose from and recommends up to 160px as the margin sizes. However, MDC layout grid doesn't impose any restrictions.
