...
The ripple effect for the FAB component is styled using [MDC Ripple mixins](https://github.com/material-components/material-components-web/blob/master/packages/mdc-ripple/README.md).
