...
class MDCSimpleMenuFoundation extends MDCFoundation {
  ...
  autoPosition_() {
    ...
    const leftOverflow = anchor.left + this.offsetX_ + this.dimensions_.width - windowDimensions.width;
