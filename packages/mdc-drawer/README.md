...
```javascript
import {MDCPersistentDrawer, MDCPersistentDrawerFoundation, util} from '@material/mdc-drawer';
```
...
```javascript
import {MDCPersistentDrawer} from '@material/mdc-drawer';
...
```javascript
import {MDCTemporaryDrawer, MDCTemporaryDrawerFoundation, util} from '@material/mdc-drawer';
```
...
```javascript
import {MDCTemporaryDrawer} from '@material/mdc-drawer';
