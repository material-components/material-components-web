...
export class MDCSlider extends MDCComponent {
  ...
  getDefaultFoundation() {
    ...
    return new MDCSliderFoundation({
      ...
      registerHandler: (eventName, handler) => this.inputControl_.addEventListener(eventName, handler),
      deregisterHandler: (eventName, handler) => this.inputControl_.removeEventListener(eventName, handler),
      registerRootHandler: (eventName, handler) => this.root_.addEventListener(eventName, handler),
      deregisterRootHandler: (eventName, handler) => this.root_.removeEventListener(eventName, handler),
