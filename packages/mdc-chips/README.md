...
Mixin | Description
--- | ---
`mdc-chip-set-margin($margin)` | Customizes the amount of space between each chip in the set
...
> _NOTE_: `mdc-chip-set-margin` also sets the amount of space between a chip and the edge of the set it's contained in.
