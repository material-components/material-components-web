...
test('on blur removes mdc-textfield--invalid if custom validity is false and input.checkValidity() returns true', () => {
  const {mockAdapter, blur} = setupBlurTest();
  blur();
  td.verify(mockAdapter.removeClass(cssClasses.INVALID));
});

test('on blur adds mdc-textfied--invalid if custom validity is false and input.checkValidity() returns false', () => {
  const {mockAdapter, blur, nativeInput} = setupBlurTest();
...
test('on blur does not remove mdc-textfield--invalid if custom validity is true and input.checkValidity() returns true', () => {
...
test('on blur does not add mdc-textfied--invalid if custom validity is true and input.checkValidity() returns false', () => {
