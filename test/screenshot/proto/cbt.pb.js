    ...
    mdc.proto = (function() {
        ...
        proto.cbt = (function() {
            ...
            cbt.CbtDevice = (function() {
                 ...
                 * @property {Array.<mdc.proto.selenium.IRawCapabilities>|null} [caps] CbtDevice caps
                ...
                /**
                 * CbtDevice caps.
                 * @member {Array.<mdc.proto.selenium.IRawCapabilities>} caps
                 * @memberof mdc.proto.cbt.CbtDevice
                 * @instance
                 */
                ...
                CbtDevice.encode = function encode(message, writer) {
                    ...
                    if (message.caps != null && message.caps.length)
                        for (var i = 0; i < message.caps.length; ++i)
                            $root.mdc.proto.selenium.RawCapabilities.encode(message.caps[i], writer.uint32(/* id 11, wireType 2 =*/90).fork()).ldelim();
                    ...
                    while (reader.pos < end) {
                        ...
                        case 11:
                            if (!(message.caps && message.caps.length))
                                message.caps = [];
                            message.caps.push($root.mdc.proto.selenium.RawCapabilities.decode(reader, reader.uint32()));
                            break;
                        case 12:
                ...
                CbtDevice.verify = function verify(message) {
                    ...
                    if (message.caps != null && message.hasOwnProperty("caps")) {
                        ...
                        for (var i = 0; i < message.caps.length; ++i) {
                            var error = $root.mdc.proto.selenium.RawCapabilities.verify(message.caps[i]);
                            if (error)
                                return "caps." + error;
                        }
                    }
                ...
                CbtDevice.fromObject = function fromObject(object) {
                    ...
                    if (object.caps) {
                        ...
                        for (var i = 0; i < object.caps.length; ++i) {
                            ...
                            message.caps[i] = $root.mdc.proto.selenium.RawCapabilities.fromObject(object.caps[i]);
                        }
                    }
                    if (object.browsers) {
                ...
                CbtDevice.toObject = function toObject(message, options) {
                    ...
                    if (message.caps && message.caps.length) {
                        ...
                        for (var j = 0; j < message.caps.length; ++j)
                            object.caps[j] = $root.mdc.proto.selenium.RawCapabilities.toObject(message.caps[j], options);
                    }
                    if (message.browsers && message.browsers.length) {
                        object.browsers = [];
            ...
            cbt.CbtBrowser = (function() {
                 ...
                 * @property {Array.<mdc.proto.selenium.IRawCapabilities>|null} [caps] CbtBrowser caps
                ...
                CbtBrowser.encode = function encode(message, writer) {
                    ...
                    if (message.caps != null && message.caps.length)
                        for (var i = 0; i < message.caps.length; ++i)
                            $root.mdc.proto.selenium.RawCapabilities.encode(message.caps[i], writer.uint32(/* id 13, wireType 2 =*/106).fork()).ldelim();
